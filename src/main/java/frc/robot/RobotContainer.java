...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_SYSidController.a().whileTrue(shooter.sysIdDynamic((SysIdRoutine.Direction.kForward)));
    m_SYSidController.b().whileTrue(shooter.sysIdDynamic((SysIdRoutine.Direction.kReverse)));
    m_SYSidController.x().whileTrue(shooter.sysIdQuasistatic((SysIdRoutine.Direction.kForward)));
    m_SYSidController.y().whileTrue(shooter.sysIdQuasistatic((SysIdRoutine.Direction.kReverse)));
  }
